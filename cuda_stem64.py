...
class stem:
    ...
    def producer(self, q, bat, d=0):
        # _path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.28.29910/bin/Hostx64/x64"
        # # ctx.pop()
        # if os.system("cl.exe"):
        ...
        self.mod = SourceModule("""
                                                    ...
                                                    if(cur_id < batches)
                                                    {
                                                        ...
                                                        if(row < height && col < width)
                                                        {
                                                            ...
                                                            result[cur_id * VOL + row * width + col]=la*(A1x*u+A1y*v)
                                                                +A2x*(la*la)/3*(3*(u*u)-3*(v*v))+A2y*(la*la)/3*6*u*v
                                                                +B2x*(3*(u*u)+(v*v))*(la*la) - B2y*(la*la)*2*u*v
                                                                +1.0/4*(la*la)*la * (A3x*(4*(u*u)*u-12*u*(v*v))+A3y*(12*(u*u)*v-4*(v*v)*v))
                                                                +(la*la)*la* (2*u*(S3x*((u*u)-(v*v))-S3y*2*u*v) +((u*u)+(v*v))*(2*S3x*u-2*S3y*v))
                                                                +C3*(la*la)*la*((u*u)+(v*v))*u
                                                                +1.0/5*(la*la*la*la) * (A4x*(5*(u*u*u*u)+5*(v*v*v*v)-30*(u*u)*(v*v))+A4y*(20*(u*u*u)*v-20*u*(v*v*v)));
                                                        }
                                                    }
                                                }
                                                    ...
                                                    if(cur_id < batches)
                                                    {
                                                        ...
                                                        if(row < height && col < width)
                                                        {
                                                            ...
                                                            result[cur_id * VOL + row * width + col]=result[cur_id * VOL + row * width + col]
                                                                +(la*la*la*la) * ( (2*u) * (D4x*((u*u*u)-3*u*(v*v))-D4y*(3*(u*u)*v-(v*v*v))) + ((u*u)+(v*v))*(D4x*(3*(u*u)-3*(v*v))-D4y*6*u*v) )
                                                                +(la*la*la*la) * (  2*((u*u)+(v*v))*2*u *(B4x*u-B4y*v) + ((u*u+v*v)*(u*u+v*v))*B4x)
                                                                +1.0/6*(la*la*la*la*la) * (A5x*(4*(u*u*u)-14*v)*((u*u)-(v*v))+A5x*((u*u*u*u)+(v*v*v*v)-14*u*v)*2*u - A5y*2*v*(3*(u*u*u*u)+3*(v*v*v*v)-10*(u*u)*(v*v))-A5y*2*v*u*(12*(u*u)-20*u*(v*v)) )
                                                                +(la*la*la*la*la) * (2*((u*u)+(v*v))*2*u*(S5x*((u*u)-(v*v))-2*u*v*S5y) + ((u*u+v*v)*(u*u+v*v))*(2*S5x*u-2*v*S5y) )
                                                                +1.0/6*(la*la*la*la*la) * C5 * 3*((u*u+v*v)*(u*u+v*v))*2*u
                                                                +(la*la*la*la*la) * (2*u*(D5x*((u*u*u*u)+(v*v*v*v)-6*(u*u)*(v*v))-D5y*4*u*v*((u*u)-(v*v))) + ((u*u)+(v*v))*(D5x*(4*(u*u*u)-12*u*(v*v))-D5y*(12*(u*u)*v-4*(v*v*v))) )
                                                                + C1 * la * u;
                                                        }
                                                    }
                                                }
                                                    ...
                                                    int width, int height,int VOL, int batches)
                                                {
                                                    ...
                                                    if(cur_id < batches)
                                                    {
                                                        ...
                                                        if(row < height && col < width)
                                                        {
                                                            ...
                                                            - A3x * (la*la) / 3 * 6 * u * v
                                                            + A3y * (la*la) / 3 * (-3 * (v*v) + 3 * (u*u))
                                                            + B2x * (la*la) * 2 * u * v
                                                            - B2y * (la*la) * ((u*u) + 3 * (v*v))
                                                            + 1.0 / 4 * (la*la*la) * (A3x * (4 * (v*v*v) - 12 * (u*u) * v)
                                                            + A3y * (4 * (u*u*u) - 12 * u * (v*v)))
                                                            + (la*la*la) * (2 * v * (S3x * ((u*u) - (v*v)) - S3y * 2 * u * v) + ((u*u) + (v*v)) * (-2 * S3x * v - 2 * S3y * u))
                                                            + C3 * (la*la*la) * ((u*u) + (v*v)) * v
                                                            + 1.0 / 5 * (la*la*la*la) * (A4x * (20 * u * (v*v*v) - 20 * (u*u*u) * v) + A4y * (5 * (v*v*v*v) + 5 * (u*u*u*u) - 30 * (u*u) * (v*v)));
                                                        }
                                                    }
                                                }
                                                    ...
                                                    int width, int height,int VOL, int batches)
                                                {
                                                    ...
                                                    if(cur_id < batches)
                                                    {
                                                        ...
                                                        if(row < height && col < width)
                                                        {
                                                            ...
                                                            double v = vv[row * width + col];
                                                            result[cur_id * VOL + row * width + col] = result[cur_id * VOL + row * width + col]
                                                            + (la*la*la*la) * ((2 * v) * (D4x * ((u*u*u) - 3 * u * (v*v)) - D4y * (3 * (u*u) * v - (v*v))) + ((u*u) + (v*v)) * (-D4x * 6 * u * v - D4y * (3 * (u*u) - 3 * (v*v))))
                                                            + (la*la*la*la) * (2 * ((u*u) + (v*v)) * 2 * v *(B4x * u - B4y * v) - (((u*u) + (v*v))*((u*u) + (v*v))) * B4y)
                                                            + 1.0 / 6 * (la*la*la*la*la) * (A5x * (4 * (v*v*v) - 14 * u) * ((u*u) - (v*v))
                                                            + A5x * ((u*u*u*u) + (v*v*v*v) - 14 * u * v) * (-2 * v) - A5y * 2 * u * (3 * (u*u*u*u) + 3 * (v*v*v*v) - 10 * (u*u) * (v*v)) - A5y * 2 * v * u * (12 * (v*v*v) - 20 * (u*u) * v))
                                                            + (la*la*la*la*la) * (2 * ((u*u) + (v*v)) * 2 * v * (S5x * ((u*u) - (v*v)) -2 * u * v * S5y) + (((u*u) + (v*v))*((u*u) + (v*v))) * (-2 * S5x * v - 2 * u * S5y))
                                                            + 1.0 / 6 * (la*la*la*la*la) * C5 * 3 * (((u*u) + (v*v))*((u*u) + (v*v))) * 2 * v
                                                            + (la*la*la*la*la) * (2 * v * (D5x * ((u*u*u*u) + (v*v*v*v) - 6 * (u*u) * (v*v)) - D5y * 4 * u * v * ((u*u) - (v*v))) + ((u*u) + (v*v)) * (D5x * (4 * (v*v*v) - 12 * (u*u) * v) - D5y * (4 * (u*u*u) - 12 * u * (v*v))))
                                                            + C1 * la * v;
                                                        }
                                                    }
                                                }
                                                                       ...
                                                                       int VOL, int batches, double pi)
                                               {
                                                   ...
                                                   if(id < batches * VOL )
                                                   {
                                                       double u = (gradient_kai_u[id]*gradient_kai_u[id]);
                                                       double v = (gradient_kai_v[id]*gradient_kai_v[id]);
                                                       ...
                                                       if (row<height && col<width)
                                                       {
                                                           ...
                                                           for(int m=0; m < mt; m++)
                                                           {
                                                               double t1 = -1 * pi * (m+1-(mt+1)*1.0 / 2) * de
                                                                           * ((u[row * width + col]*u[row * width + col]) + (v[row * width + col]*v[row * width + col])) * la;
        ...
        # print("计算中")
        # ctx.push()
        self.createNewPP2 = self.mod.get_function("createNewPP2")
        self.getKai = self.mod.get_function("getKai")
        self.getW = self.mod.get_function("getW")
        self.gradient_u = self.mod.get_function("gradient_u")
        self.gradient_v = self.mod.get_function("gradient_v")
        self.getESCoh = self.mod.get_function('getESCoh')
        self.getT = self.mod.get_function('getT')
        self.getTlittleAll = self.mod.get_function('getTlittleAll')
        self.myIfftShift = self.mod.get_function('myIfftShift')
        self.accumulate_result = self.mod.get_function('accumulate_result')
